...
#              over all cropland area. Analysis from 2016-2100.
...
#   practice_2 = practice_2[scen_match == TRUE] 
#   # drop unnecessary columns
...
#   # remove extra cp (make dt unique)
#   d_g_yield_m1_dt = unique(d_g_yield_m1_dt) 
...
{ ## 3. max GHG mitigation (no crop yield loss)
  ...
  # practice_3 = practice_3[scen_match == TRUE] 
  # # drop unnecessary columns
